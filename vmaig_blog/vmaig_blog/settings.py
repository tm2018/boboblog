...
EMAIL_SUBJECT_PREFIX = u'Bobo'       # 为邮件Subject-line前缀,默认是'[django]'
...
# 网站标题等内容配置
WEBSITE_TITLE = u'灰狼的博客|着点于运维开发的个人技术博客'
WEBSITE_WELCOME = u'欢迎来到灰狼的博客，若需交流，请加qq:1744381765或者微信:tm2018'
